...
public class FullScannerActivity extends BaseScannerActivity implements MessageDialogFragment.MessageDialogListener,
    ...
    public static final String TAG = "FullScan Activity";
    ...
    public void onCreate(Bundle state) {
        ...
        Log.d("FULLSCAN", "Scanning Event "+ event_name);

        pd = new ProgressDialog(FullScannerActivity.this);

        contentFrame = (ViewGroup) findViewById(R.id.content_frame);
        toggleFlashLight = (ToggleButton) findViewById(R.id.toggleButtonLight);
...
//                    sessionListDialog(options);
        ...
        if (ContextCompat.checkSelfPermission(FullScannerActivity.this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(FullScannerActivity.this,
                    Manifest.permission.CAMERA)) {
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Uri uri = Uri.fromParts("package", FullScannerActivity.this.getPackageName(), null);
                        intent.setData(uri);
                ...
                ActivityCompat.requestPermissions(FullScannerActivity.this,
    ...
    public void onResume() {
        ...
        Log.v(TAG, "Resuming camera" + mCameraId);
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA)
                == PackageManager.PERMISSION_DENIED){
            ActivityCompat.requestPermissions(this, new String[] {Manifest.permission.CAMERA}, mCameraId);
        }
    ...
    private void sessionListDialog(String[] options){
        AlertDialog.Builder b = new AlertDialog.Builder(FullScannerActivity.this);
        b.setTitle("Session");
        ...
        b.setItems(mStringArray, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (s =="Add New"){
                    ...
                    SaveSharedPreference.setSessionOption(FullScannerActivity.this, s);
                    actionB(s);
                    session_option = s;
                }
//
    ...
    private void addSessionDialog(){
        ...
        LayoutInflater li = LayoutInflater.from(FullScannerActivity.this);
        View promptsView = li.inflate(R.layout.session_prompt, null);

        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                FullScannerActivity.this);
...
//        pbar.show();
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, system_url, post_dict,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(FullScannerActivity.this, "No More Items Available", Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
    ...
    public void handleResult(Result rawResult) {
        ...
        if (scan_type.equals("OFFLINE")) {
            ...
            pd.setMessage("Please Wait...");
            pd.show();
            String[] found = getDatabaseTicketCode(rawResult.getContents());
            pd.dismiss();
            ...
            String ticketCode = Base64.encodeToString(rawResult.getContents().getBytes(), Base64.DEFAULT);
            try {
                pd.setMessage("Please Wait....");
                pd.show();
    ...
    public void popUp(String[] values){
        final AlertDialog.Builder builder = new AlertDialog.Builder(this);
        LayoutInflater factory = LayoutInflater.from(this);
        final View view = factory.inflate(R.layout.custom, null);
        builder.setTitle("TICKET VALIDATING");
        ImageView image = (ImageView) view.findViewById(R.id.image);
        TextView cnt = (TextView) view.findViewById(R.id.counttext);
        if(values[0] == "1"){
            image.setImageResource(R.drawable.validstamp);
            cnt.setText("COUNT: "+ values[1]);
            System.out.println("COUNT "+values[1]);
        }
        if(values[0] == "0"){
            image.setImageResource(R.drawable.invalidstamp);
            cnt.setText("COUNT: " + values[1]);
            //System.out.println("COUNT "+values[1]);
        }
    ...
    public String[] getMemberShipDatabaseTicketCode(String ticketCode){
        ...
        if (cursor.moveToFirst()) {
            ...
            String status = "true";
            params = new String[]{"1", "" + scan_count, pc};
            if(ticket_usage != 0) {
                if (scan_count > ticket_usage) {
                    params = new String[]{"0", "" + scan_count, pc};
                    status = "false";
                }
            }
            updateScannedTicket(ticketCode, scan_count, status);
