...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.v("LoginActivity", "PREFERENCE FOR LOG IN + " + SaveSharedPreference.getUserLoggedInStatus(this));
    ...
    public void loadHome(String response){
        try {
            ...
            if(jsonStatus.equals("GOOD")){
                finish();
                showProgress(false);
                SaveSharedPreference.setLoggedInUserUserName(this, Base64.encodeToString(mEmailView.getText().toString().getBytes(), Base64.DEFAULT));
                SaveSharedPreference.setLoggedInUserPassword(this, Base64.encodeToString(mPasswordView.getText().toString().getBytes(), Base64.DEFAULT));
                SaveSharedPreference.setUserLoggedInStatus(this, true);
                ...
                Toast.makeText(LoginActivity.this, "Error " + obj.getString("data").toString(), Toast.LENGTH_LONG);
